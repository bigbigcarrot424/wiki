...
insert into `ebook` (id, name, description) values (4,'Mysq1入门教程','零基础入门Mysql开发，企业级应用开发2最佳首选框架');
...
insert into `user` (id, `login_name`, `name`, `password`) values (12, 'admin', 'admin', 'e70e2222a9d67c4f2eae107533359aa4');
...
set t1.view_count = t2.view_count, t1.vote_count = t2.vote_count where t1.`date` = curdate() and t1.ebook_id = t2.id;
